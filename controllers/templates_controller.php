...
class TemplatesController extends AppController {
	...
	function add() {
		...
		$yearLevels = $this->Template->YearLevel->find('list');
		$educLevels = $this->Template->EducLevel->find('list');
		$users = $this->Template->User->find('list');
		$this->set(compact('yearLevels', 'educLevels', 'users'));
	}
